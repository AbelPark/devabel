---
title: react-hook-form validate (class-validator 활용)
date: '2023-07-12'
tags: ['react', 'react-hook-form', 'class-validator', 'class-transformer']
draft: false
summary: react-hook-form을 활용한 객체 배열에서 class-validator를 활용한 validation 체크
layout: PostSimple
---
